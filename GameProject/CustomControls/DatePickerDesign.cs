...
namespace GameProject.CustomControls
{
    internal class DatePickerDesign : DateTimePicker
    {
        //Fields
        //-> Appearance
        ...
        private Image calendarIcon = Animation.calendarWhite;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.6F)
                    calendarIcon = Animation.calendarDark;
                else calendarIcon = Animation.calendarWhite;
                this.Invalidate();
            }
        }
